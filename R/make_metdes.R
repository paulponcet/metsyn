...
#' 
#' @note 
#' These data are distributed by Meteo France under the terms of the Open 
#' Licence, provided by Etalab and designed to be compatible with the 
#' "Creative Commons Attribution 2.0" (CC-BY 2.0) licence of Creative Commons. 
