#' @title 
#' Descriptive information on the 'metsyn' dataset
#' 
#' @description 
#' The \code{metdes} dataset gives some descriptive information on the 
...
#' @docType data
#' @keywords datasets
#' @format a \code{\link[tibble]{tibble}} with 5 columns and 59 rows. 
#' @name metdes
NULL
